...
const members = [
  { name: "Muhamad Alfian Holidi", role: "Ketua Kelompok", info: "Informatika '26" },
  { name: "Anggota 2", role: "Sekretaris", info: "Informatika '26" },
  { name: "Anggota 3", role: "Bendahara", info: "Informatika '26" },
  { name: "Anggota 4", role: "Anggota", info: "Informatika '26" },
  { name: "Anggota 5", role: "Anggota", info: "Informatika '26" },
  { name: "Anggota 6", role: "Anggota", info: "Informatika '26" },
];
            ...
            <div className="relative w-full aspect-square bg-muted rounded-[30px] overflow-hidden mb-8">
              <div className="absolute inset-0 bg-primary/40 opacity-0 group-hover:opacity-100 transition-opacity flex flex-col items-center justify-center gap-4">
                <div className="flex gap-3">
                  <button className="p-3 bg-background rounded-full hover:scale-110 transition-transform shadow-lg"><Github size={20} /></button>
                  <button className="p-3 bg-background rounded-full hover:scale-110 transition-transform shadow-lg"><Instagram size={20} /></button>
                  <button className="p-3 bg-background rounded-full hover:scale-110 transition-transform shadow-lg"><Linkedin size={20} /></button>
                </div>
              </div>
